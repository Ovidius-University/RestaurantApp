...
using WebAppUI.Areas.Delivery.Models.ViewModels;
using WebAppUI.Areas.Delivery.Models.DTOs;
...
public class PastOrderController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var Orders = _mapper.Map<List<OrderVm>>(
                ...
                .Where(c => c.IsDelivery == true && c.WorkerId == empSched.EmployeeId)
                .OrderBy(c => c.IsFinal)
    ...
    [Route("Delivery/PastOrder/Details/{id}")]
    ...
    public async Task<IActionResult> TakeOrder([FromRoute] int id, [FromForm] ExistentDeliveryDto ModifiedOrder)
    {
            ...
            try
            {
                ...
                foreach (var item in empSched)
                {
                    ...
                    var Order = await _context.Orders
                        ...
                        .Include(c => c.OrderContents)
                        .Include(c => c.DeliveryName)
                        .Where(c => c.Id == id && c.IsDelivery == true
                ...
                if (ModifiedOrder.WorkerId != 0 && ModifiedOrder.WorkerId != null) {
        ...
        {
            output.WorkerId = empSche!.EmployeeId;
        }
        else output.WorkerId = null;
    ...
    // GET: Delivery/PastOrder/FeedBack/5
    [Route("Delivery/PastOrder/FeedBack/{id}")]
    ...
    [Route("Delivery/PastOrder/TimePeriod/{id}")]
