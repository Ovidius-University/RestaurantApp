...
public class SaleController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var ordercontents = _mapper.Map<List<OrderContentVm>>(
            ...
            .Where(c => c.Food!.IsHomeMade == true && c.Food.ChefId == empSched.EmployeeId)
            .ToListAsync());
        ...
        {
            Chef = empSched.Employee!.UserName!,
            ListSales = sales
        };
        return View(output);
    }
    ...
    public async Task<IActionResult> DetailsItem(int? id)
    {
        ...
        var ordercontents = _mapper.Map<List<OrderContentVm>>(
            ...
            .Include(c => c.Food)
            .Include(c => c.Food!.Offer)
            .Where(c => c.Food!.IsHomeMade == true && c.Food.ChefId == empSched.EmployeeId && c.FoodId == id)
            .ToListAsync());
    ...
    [Route("Chef/Sales/DetailsTimeItem")]
