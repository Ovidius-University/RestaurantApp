...
public class OrderController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        OrderContents = OrderContents
            .Where(q => foods.Any(j => j.Id == q.FoodId))
            .ToList();
        ...
        Orders = Orders
                .Where(i => OrderContents.Any(j => j.OrderId == i.Id))
    ...
    // GET: Order/Details/5
    [Route("Manager/Order/Details/{id}")]
    ...
    [Route("Manager/Order/FeedBack/{id}")]
    ...
    [Route("Manager/Order/TimePeriod/{id}")]
    public async Task<IActionResult> TimePeriod(int? id)
    {
        ...
        Orders = Orders
                .Where(i => OrderContents.Any(j => j.OrderId == i.Id) && i.IsFinal)
                .OrderBy(c => c.IsFinal)
    ...
    public async Task<IActionResult> Delete(int? id)
    {
        ...
        {
            TempData["MessageManagerOrder"] = $"Order number {Order.Id} cannot be removed as it has been completed! You'll need to make it not final!";
            return RedirectToAction(nameof(Index));
        }
